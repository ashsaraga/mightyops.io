	...
	<section class="portrait has-background-evening has-text-white">
		<div class="is-flex">
			<div class="fits-flex-66">
				...
				<p class="is-size-5 has-text-weight-regular">In 2017 I joined Middle Seat, a digital consulting firm, working two years in DC to build and lead the development program.  These days I can be found down South doing progressive campaigning and coding the occasional text-based adventure game.</p>
			</div>
